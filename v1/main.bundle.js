...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__domain_domain_component__ = __webpack_require__("../../../../../src/app/domain/domain.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_domain_service__ = __webpack_require__("../../../../../src/app/providers/domain.service.ts");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_3__domain_domain_component__["a" /* DomainComponent */]
        ],
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_4__angular_router__["d" /* RouterModule */].forRoot([
                ...
                {
                    path: 'domain',
                    component: __WEBPACK_IMPORTED_MODULE_3__domain_domain_component__["a" /* DomainComponent */],
                }
            ], { useHash: false })
        ],
        providers: [
            __WEBPACK_IMPORTED_MODULE_5__providers_domain_service__["a" /* DomainService */]
        ],
...
/***/ "../../../../../src/app/domain/domain.component.html":
/***/ (function(module, exports) {

module.exports = "<script src=\"node_modules/chart.js/src/chart.js\"></script>\n<main>\n    <div class=\"navbar navbar-default\">\n        <div class=\"container-fluid\">\n            <div class=\"navbar-header\">\n                <img class=\"pull-left app-logo\" src=\"https://developers.italia.it/assets/icons/logo-it.png\">\n                <h1 class=\"pull-left app-title\">Security Dashboard</h1>\n            </div>\n\n            <div class=\"collapse navbar-collapse\">\n\n            </div>\n        </div>\n    </div>\n    <div class=\"container\">\n\n        <div class=\"page-title-mobile\"><h2>Domains List</h2></div>\n\n        <div class=\"row\">\n\n            <div class=\"chart-container pull-right col-md-4 text-center\" *ngIf=\"chartData\">\n                <canvas baseChart\n                        [data]=\"chartData\"\n                        [labels]=\"chartLabels\"\n                        [chartType]=\"chartType\"\n                        (chartHover)=\"chartHovered($event)\"\n                        (chartClick)=\"chartClicked($event)\"></canvas>\n            </div>\n            <div class=\"domain-container col-md-8\">\n                <form class=\"domain-search-form\">\n                    <div class=\"app-search\">\n                        <input placeholder=\"Search...\" name=\"search\" class=\"form-control form-control-inline\" type=\"search\" [(ngModel)]=\"term\" (keypress)=\"searchPressHandler($event)\">\n                    </div>\n                    <div class=\"app-filters-container\">\n                        <button type=\"button\" class=\"btn btn-default btn-xs search-button\" (click)=\"search()\">Search</button>\n                        <button type=\"button\" class=\"btn btn-default btn-xs reset-search-button\" (click)=\"resetSearch()\" *ngIf=\"term\">Reset</button>\n                    </div>\n                </form>\n                <div class=\"domain-table table-responsive\">\n                    <table class=\"table table-striped table-condensed table-bordered\">\n                        <thead>\n                        <tr>\n                            <th class=\"sortable\">Domain</th>\n                            <th class=\"sortable\">Canonical URL</th>\n                            <th class=\"sortable\">Valid HTTPS</th>\n                        </tr>\n                        </thead>\n                        <tbody>\n                        <tr *ngFor=\"let domain of domains\" class=\"item\">\n                            <td>\n                                {{domain.domain}}\n                            </td>\n                            <td>\n                                {{domain.canonicalURL}}\n                            </td>\n                            <td>\n                                <span class=\"show-in-responsive\">HTTPS:</span> {{domain.validHTTPS? 'Yes' : 'No'}}\n                            </td>\n                        </tr>\n                        </tbody>\n                    </table>\n                </div>\n            </div>\n        </div>\n    </div>\n</main>\n\n\n\n\n\n"

/***/ }),

/***/ "../../../../../src/app/domain/domain.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DomainComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_domain_service__ = __webpack_require__("../../../../../src/app/providers/domain.service.ts");
...
var DomainComponent = (function () {
    function DomainComponent(_router, _route, domainService) {
        this._router = _router;
        this._route = _route;
    ...
    DomainComponent.prototype.getDomains = function () {
        ...
        this.domainService.getList()
            .subscribe(function (domains) { return _this.setData(domains); }, function (error) { return _this.errorMessage = error; });
    };
    /**
     * ricerca per dominio
     */
    DomainComponent.prototype.search = function () {
        var _this = this;
     ...
     * resetto la ricerca
     */
    DomainComponent.prototype.resetSearch = function () {
    ...
    // events
    DomainComponent.prototype.chartClicked = function (e) {
        console.log(e);
    };
    DomainComponent.prototype.chartHovered = function (e) {
        console.log(e);
    };
...
DomainComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'domain',
        template: __webpack_require__("../../../../../src/app/domain/domain.component.html"),
        styles: [__webpack_require__("../../../../../src/app/domain/domain.css")],
     ...
     */
    ,
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* Router */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__providers_domain_service__["a" /* DomainService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__providers_domain_service__["a" /* DomainService */]) === "function" && _c || Object])
], DomainComponent);
...
/***/ "../../../../../src/app/providers/domain.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var DomainService = (function () {
     ...
     */
    DomainService.prototype.search = function (term) {
        return this.http.get('../service/domain.php?term=' + term)
     ...
     * @returns {Observable<Domain[]>}
     */
    DomainService.prototype.getList = function () {
